...
![程序首页](./ScreenTimeoutManager/images/程序首页.png)
...
| **SVG 窗口图标** | 窗口标题栏矢量图标 + 多分辨率 EXE 图标 |
...
│       ├── Resources/
│       │   ├── Styles.xaml                   # 全局样式定义
│       │   ├── AppIcon.svg                   # SVG 矢量窗口图标
│       │   └── app_icon.ico                  # 多分辨率 EXE 图标
│       ├── Models/
...
├── images/                                   # 截图
├── dist/                                     # 发布输出（ScreenTimeoutManager.exe）
└── README.md                                 # 本文档
```
